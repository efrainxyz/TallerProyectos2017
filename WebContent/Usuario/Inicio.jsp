    ...
    <div> 
        ...
        <div class="container-fluid">
    		<div class="row center-block">
    			<div  onclick='location.href="<%=request.getContextPath()%>/Usuario/reportePlanCurricular.jsp";' class=" col-md-12 col-sm-12 col-xs-12" style="padding:30px;margin:30px auto;height:200px;text-align:center;vertical-align:middle; ">
    				<div  class="click" style="border:2px solid black;width:auto;height: 200px;font-size:20px;">Reporte Plan Curricular</div>
    			</div>
