        ...
        <div class="container-fluid">
    		...
    		<div class="row" align="center" style="padding:15px;" >
    			<div class="col-md-12 col-xs-12" align="center" style="padding:10px 5px;"> 
    				<button type="button" style="max-width:400px; " class="btn btn-success  tam btn-lg btn-block">Reporte Sunedu C2</button>
    			</div>
    			<div class="col-md-12 col-xs-12" align="center" style="padding:10px 5px;"> 
    				<button type="button"  style="max-width:400px; " class="btn btn-success tam btn-lg btn-block">Reporte Plan de Estudio</button>
    			</div>
    			<div class="col-md-12 col-xs-12" align="center" style="padding:10px 5px;"> 
    				<button type="button"  style="max-width:400px; " class="btn btn-success  tam btn-lg btn-block">Reporte Plan de Estudio x Horas</button>
    			</div>
    			<div class="col-md-12 col-xs-12" align="center" style="padding:10px 5px;"> 
    				<button type="button" style="max-width:400px; " class="btn btn-success  tam btn-lg btn-block">Reporte Resumen Curricular</button>
    			</div>
    			<div class="col-md-12 col-xs-12" align="center" style="padding:10px 5px;"> 
    				<button  type="button" style="max-width:400px; "  class="btn btn-success tam btn-lg btn-block">Malla Curricular</button>
    			</div>
